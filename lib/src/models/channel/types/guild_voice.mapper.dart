...
class GuildVoiceChannelMapper extends ClassMapperBase<GuildVoiceChannel> {
  ...
  static bool _$isNsfw(GuildVoiceChannel v) => v.isNsfw;
  static const Field<GuildVoiceChannel, bool> _f$isNsfw = Field(
    'isNsfw',
    _$isNsfw,
  );
